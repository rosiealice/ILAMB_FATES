...
mpirun -n 8 ilamb-run --config ~/fates-global-cal/ilamb_scripts/config_files/ilamb_CLMFATES_nocomp_minimal.cfg --model_root  /glade/cheyenne/scratch/rfisher/ --models  RTM_ens36_case_0  RTM_ens36_case_3 RTM_ens36_case_4 --model_setup  ~/fates-global-cal/ilamb_scripts/model_setup_files/model_setup_090623_RTMens36_shift  --filter  .clm2.h0.202 --build_dir ~/fates-global-cal/ilamb_scripts/builddir --clean
